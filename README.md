<!-- mcp-name: CSOAI-ORG/html-parser-ai-mcp -->
[![MCP Scorecard: 74/100](https://img.shields.io/badge/proofof.ai-74%2F100-5b21b6)](https://proofof.ai/scorecard/html-parser-ai-mcp.html)
...
[![PyPI](https://img.shields.io/badge/PyPI-Install-3775a9)](https://pypi.org/project/html_parser_ai_mcp/)
...
```bash
# Install via pip
pip install html_parser_ai_mcp

# Or install via Smithery
npx -y @smithery/cli@latest install html-parser-ai-mcp --client claude
```
...
- [Full Documentation](https://docs.meok.ai/html-parser-ai-mcp)
